...
use ptest;
create table property (  propertyid int, price double, location text,roomnumber int, bedroomnumber int, timevisited int, visistedate datetime, primary key (propertyid));
insert into property values ( 100, 200000, 'Paris', 4, 1, 12, '2000-11-06 13:20');
...
create table house (id int, price double, location text, numberrooms int, numberbedrooms int, timevisited int, numberfloor int, surface double, gardensurface double, swimmingpool bool, primary key (id)) ; 
...
create table apartment (id int, price double, location text, numberrooms int, numberbedrooms int, timevisited int, numberfloor int, surface double, elevator bool, floornumber int, parking bool, primary key (id)) ; 
