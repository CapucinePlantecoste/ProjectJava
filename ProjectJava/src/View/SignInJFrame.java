...
/**
 * Class SignInJFrame which is a JFrame that is used in order to let a user
 * SignIn(as a seller or as a buyer)
 *
 * @author CAP
 */
public class SignInJFrame extends javax.swing.JFrame {
     ...
     * @param off is the ArrayList of all the offersf the app
     */
    ...
    /**
     * Method that is used to add a buyer to the program and to the database
     */
    ...
    /**
     * Method that is used to add a seller to the program and to the database
     */
    ...
    /**
     * Method that counts the number of users that have the same username as the
     * one that the new customer wants to pick
     *
     * @return the number of users that have this username (if it is not 0 the
     * new customer will have to change his username)
     */
    public int test() {
