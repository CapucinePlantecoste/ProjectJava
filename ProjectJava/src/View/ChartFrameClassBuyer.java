 ...
 * @author CAP
 */
public class ChartFrameClassBuyer extends javax.swing.JFrame {
    

    /**
     * Creates new form ChartFrameClass
     */
    public ChartFrameClassBuyer(Buyer a , ArrayList<Buyer> b, ArrayList<Seller> s, ArrayList<Employee> e, ArrayList<Property> prop, ArrayList<Visit> vis, ArrayList<Offer> off) {
        buyers = b;
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(930, 170, 450, 40);
        ...
        jButton3.setBounds(930, 260, 450, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartFrameClassBuyer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChartFrameClassBuyer(newbuyer , buyers, sellers, emp, pr, v, o).setVisible(true);
            }
        });
    }
