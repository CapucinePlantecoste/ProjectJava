...
public class ConnectingJFrame extends javax.swing.JFrame {//this frame corresponds to the one we open when we want to connect as a buyer, seller or employee
     ...
     */
    public ConnectingJFrame(String t, ArrayList<Buyer> b, ArrayList<Seller> s, ArrayList<Employee> e, ArrayList<Property> prop, String u, String us, String p) {//constructor 
        ...
        if (type.equals("buyers")) {//if the customer is a buyer
            ...
            for (int i = 0; i < buyers.size(); ++i) {//we go through the whole list of buyers 
                ...
                if (buyers.get(i).getpassword().equals(password) && buyers.get(i).getusername().equals(username)) {//we check if the username and password correspond to those in the database  
                    ...
                    j++;
                    BuyerFirst newframe = new BuyerFirst(buyers.get(i),buyers, sellers, emp,pr, url, USERNAME,PASSWORD);
                    newframe.nom();  
            ...
            for (int i = 0; i < sellers.size(); ++i) {//we go through the whole list of sellers
                ...
                if (sellers.get(i).getpassword().equals(password) && sellers.get(i).getusername().equals(username)) {//we check if the username and password correspond to those in the database  
                    ...
                    j++;
                   SellerFirst newframe = new SellerFirst(sellers.get(i),buyers, sellers, emp,pr, url, USERNAME,PASSWORD);
                   newframe.nom();
        ...
        else//the customer is an employee
        {
            for (int i=0;i<emp.size();++i)//we go through the whole list of employees
            {
                ...
                {//connexion worked
                    ...
                    j++; 
                    EmployeeFirst newframe = new EmployeeFirst(emp.get(i),buyers, sellers, emp,pr, url, USERNAME,PASSWORD);
                    newframe.nom();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ConnectingJFrame(type, buyers, sellers, emp,pr,url,USERNAME,PASSWORD).setVisible(true);//we open the frame when we run it 
            }
        });
    }
