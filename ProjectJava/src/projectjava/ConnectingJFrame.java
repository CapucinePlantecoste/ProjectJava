...
public class ConnectingJFrame extends javax.swing.JFrame {//this frame corresponds to the one we open when we want to connect as a buyer, seller or employee
     ...
     */
    public ConnectingJFrame(String t, ArrayList<Buyer> b, ArrayList<Seller> s, ArrayList<Employee> e) {//constructor 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ConnectingJFrame(type, buyers, sellers, emp).setVisible(true);//we open the frame when we run it 
            }
        });
    }
