...
public class BuyerFirst extends javax.swing.JFrame {
     ...
     */
    public BuyerFirst(Buyer a, ArrayList<Buyer> b, ArrayList<Seller> s, ArrayList<Employee> e, String u, String us, String p) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(1200, 460, 110, 40);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "House", "Apartment" }));
        jPanel2.add(jComboBox1);
        jComboBox1.setBounds(930, 360, 76, 20);
        ...
        jLabel10.setText("Number of Bedrooms");
        ...
        jLabel11.setText("Number of Floors");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuyerFirst(newbuyer, buyers, sellers, emp, url, PASSWORD, USERNAME).setVisible(true);
            }
        });
    }
