...
drop table property;
create table property (id int not null, type text, description text, price double not null, location text not null, numberrooms int not null, numberbedrooms int not null, timevisited int not null, numberfloors int not null, surface double not null, gardensurface double, swimmingpool bool, elevator bool, floornumber int, parking bool, idseller int, foreign key(idseller) references Seller(idseller), primary key (id));
insert into property values (01, 'House', 'House in Paris with a small garden', 170000, 'Paris', 4, 2, 3 , 2 , 120, 40, false,null,null,null,10002);
insert into property values( 02, 'House', ' House near the sea in Baden',1000000, 'Baden', 8, 5, 10, 3, 1000, 200, false,null,null,null,10001);
insert into property values (03, 'House', 'Big House with swimming pool in Nice',1300000, 'Nice', 6, 3, 5, 3, 1200, 500, true,null,null,null,10003);
insert into property values (04, 'House', ' Tiny house in Trouville',230000, 'Trouville', 5, 3, 7, 5, 40, 5, false,null,null,null,10004);
insert into property values (05, 'House', 'Large house in Saint-Tropez',6000000, 'Saint-Tropez', 6, 4, 35, 2, 500, 200, true,null,null,null,10005);
insert into property values (06, 'House', 'Big house in a quiet place in Le Pecq',900000, 'Le Pecq', 6, 3, 17, 3, 1000, 700, false,null,null,null,10006);
insert into property values (07, 'Apartment', 'Small appartment in Paris ',245000, 'Paris', 3, 2, 3, 1, 50,null,null, false, 3, false,10002) ; 
insert into property values (08, 'Apartment', 'Beautiful apartment in Nantes',1000000, 'Nantes', 5, 3, 10, 1, 75, null,null,true, 2, false,10006); 
insert into property values (09, 'Apartment', 'Big apartment in Lyon',1300000, 'Lyon', 6, 3, 32, 2, 95,null,null, true, 3, true,10001) ; 
insert into property values (10, 'Apartment','Small appartment near the sea',250000, 'Marseille', 3, 2, 7, 1, 35, null,null,false, 1, false,10003) ; 
...
drop table offer;
create table offer(idoffer int, idbuyer int, idproperty int, price double, foreign key(idproperty) references Property(id), foreign key (idbuyer) references Buyer(idbuyer),primary key(idoffer));
